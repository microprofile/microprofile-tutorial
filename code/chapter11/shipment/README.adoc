...
| PUT
| /api/shipments/{shipmentId}/delivery-date
...
* OpenAPI: http://localhost:8060/openapi
* Swagger UI: http://localhost:8060/openapi/ui

== Monitoring

Health and metrics endpoints (served at the server root, not under the `/shipment` context root):
