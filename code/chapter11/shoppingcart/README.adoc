...
NOTE: `productName`, `price`, and `imageUrl` are optional; they will be fetched from the Catalog service if not provided.
...
OpenAPI documentation is available at: `http://localhost:4050/openapi/ui`
